...
public class lawnController5 implements Initializable
{
    ...
    @FXML
    private ImageView mine_tile2;
    private String mine_tile_loc2;
    ...
    private ImageView tile_list[] = new ImageView[]{pea_tile, sun_tile, walnut_tile, mine_tile, mine_tile2};
...
//                    System.out.println("clicked mine");
                    try {
                        temp_Image = new Image(new FileInputStream(
                                "src/resources_not/potato.gif"));
                        selected_plant = "Bomb2";
                    } catch (FileNotFoundException e) {
                        e.printStackTrace();
                    }
                }
...
//                    plant.fitWidthProperty().bind(anchorPane.widthProperty());
                    ...
                    else if(selected_plant=="Bomb")
                    {
                        ...
                        Bomb2 s = new Bomb2(0,0, plant);
                        plantList.add(s);
                        plants_matrix[i][b] = s;
                        sunCounter = sunCounter - 25;
                        sunTokenText.setText(String.valueOf(sunCounter));
                        for(Zombie zombie:zombieWave1){
                            checkCollBombZomb(s, zombie);
                        }
                    ...
                    if(selected_plant == "Bomb2") {
                        new Thread() {
                            public void run() {
                                Platform.runLater(new Runnable() {
                                    public void run() {
                                        if (selected_plant == "Bomb2") {
                                            mine_tile2.setDisable(true);
                                            mine_tile2.setOpacity(0.5);
                                        }
                                    }
                                });
                                try {
                                ...
                                Platform.runLater(new Runnable() {
                                    public void run() {
                                        mine_tile2.setDisable(false);
                                        mine_tile2.setOpacity(1);
                                    }
                                });
                            }
                        }.start();
...
//                            }
    ...
    public void checkCollBombZomb(Plant plant, Zombie zombie){
        ImageView imageView1 = plant.getImageView();
        ImageView imageView2 = zombie.getZombie();
